...
class Maps extends Component {
    ...
    async onMapReady() {
        ...
        {
            this.setState({ status: this.props.interactive ? "mapReady" /* Status.MapReady */ : "cameraReady" /* Status.CameraReady */ });
        }
        this.onRegionChangeComplete();
    }
    async onRegionChangeComplete() {
        if (this.state.status === "mapReady" /* Status.MapReady */) {
            this.setState({ status: "cameraReady" /* Status.CameraReady */ });
        }
    }
    async parseMarkers() {
        const markers = [
